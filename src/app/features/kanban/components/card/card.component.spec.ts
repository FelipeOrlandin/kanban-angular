...
import { Task, TASK_STATUS_ORDER, TaskUpdatePayload } from '../../models/task.model';
...
describe('KanbanCardComponent', () => {
  ...
  describe('eventos de clique (públicos)', () => {
    ...
    it('moveForward emite ao clicar', () => {
      ...
      const btn = fixture.debugElement.query(By.css('.kanban-card__nav-btn--forward'));
    ...
    it('moveBack emite ao clicar', () => {
      ...
      const btn = fixture.debugElement.query(By.css('.kanban-card__nav-btn:not(.kanban-card__nav-btn--forward)'));
      if (btn) btn.nativeElement.click();
      expect(spy).toHaveBeenCalledWith('card-1');
    });
  });
